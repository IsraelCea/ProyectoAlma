...
class SampleApp(tk.Tk):
    def __init__(self, *args, **kwargs):
        ...
        self.frames = {}
        for F in (Cuentas, Empresas, Proveedores, Usuarios):
...
class Cuentas(tk.Frame):
    ...
    def __init__(self, parent, controller):
        ...
        # Cuadro Gráficos
        cuadrograf=LabelFrame(self,width=200,height=230,background='grey100',text='Gráfico')
...
#Cuenta la cantidad de movimientos por cuenta
    ...
    #Cuenta la cantidad de movimientos de cada cuenta y las ordena de menor a mayor
...
class Empresas(tk.Frame):
    ...
    def __init__(self, parent, controller):
        ...
        # Input 1
        Label(cuadro, text='Cuenta:').grid(row=0, column=0, padx=10,pady=10)
        self.cuenta = Entry(cuadro)
        self.cuenta.grid(row=0, column=1)
        self.cuenta.focus()
        # Periodos
        Label(cuadro, text='Periodo:').grid(row=1, column=0, padx=10,pady=10)
        ...
        self.tabla.heading('#0', text='N° Cuenta', anchor=CENTER)
        self.tabla.heading('#1', text='Descripción')


        button1 = tk.Button(self, text="Cuentas", width=10,
                            command=lambda: controller.show_frame("Cuentas")).grid(row=0, column=1,padx=2.5,pady=2.5)
        button2 = tk.Button(self, text="Empresa", width=10, background='grey60',
                            command=lambda: controller.show_frame("Empresas")).grid(row=0, column=2,padx=2.5,pady=2.5)
        button3 = tk.Button(self, text="Proveedores", width=10,
                            command=lambda: controller.show_frame("Proveedores")).grid(row=0, column=3, padx=2.5, pady=2.5)
        button4 = tk.Button(self, text="Usuarios", width=10,
                            command=lambda: controller.show_frame("Usuarios")).grid(row=0, column=4,padx=2.5,pady=2.5)
...
class Usuarios(tk.Frame):
    ...
    def __init__(self, parent, controller):
        tk.Frame.__init__(self, parent)
        self.controller = controller
        label = tk.Label(self, text="Usuarios", font=controller.title_font).grid(row=0, column=0,sticky=W,padx=10)
        #label.pack(side="top", fill="x", pady=10)
        ...
        button3 = tk.Button(self, text="Proveedores", width=10,
                            command=lambda: controller.show_frame("Proveedores")).grid(row=0, column=3, padx=2.5, pady=2.5)
        button4 = tk.Button(self, text="Usuarios", width=10, background='grey60',
                            command=lambda: controller.show_frame("Usuarios")).grid(row=0, column=4,padx=2.5,pady=2.5)
